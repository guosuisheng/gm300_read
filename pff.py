...
# 403 0x0000 0x0127(2701) hex(0x00 ^ 0x00 ^ 0x01 ^ 0x27 ^ 0xff) = 0xd9  
# position 0x2e0 00 00 0127 eeprom position 0xb600+0x2e0 = 0xb8e0
# 
# 430 0x177b 0x0141 hex(0x17 ^ 0x7b ^ 0x01 ^ 0x41 ^ 0xf5) = 0xd8
       #7b17    4101
#gwrite2(0xb8e0," 7b 17 41 01")
#gwrite2(0xff00,"f5")
# goback original
#gwrite2(0xb8e0,"00 00 27 01")
#gwrite2(0xff00,"ff")
#>>> 403000000+6250*0x150
#405100000 405.05
#403000000+6250*0x120f
#0x0f 12 431893750 431.82
#>>> 403000000+5000*0x120f
#426115000 4257
#>>> 403000000 + 0x1350 * 5000
#427720000
...
job(start,n)
#job(0xff00,n)
#           2F 01 F1 01 00 57 00 57 00 00 00 00 30 00 00 00
fz="2F 01 F2 01 17 70 17 70 00 00 00 00 30 00 00 00 00 00 00 00".replace(" ","")
fz2="2F 01 F2 02 13 50 13 50 00 00 00 00 30 00 00 00 00 00 00 00".replace(" ","")
f=checksum(fz)
#f2=checksum(" 52 01 57 00 57 00 00 00 00 30 00 00 00 00 00 00 00".replace(" ",""))
gwrite2(start,f)
#gwrite2(start+0x15,f2)
#gwrite2(0xff00,"ff")
#job(start+8,n)
#job(start+16,n)
#f="2f 01 00 01 00 57 00 57 00 00 00 00 30 00 00 00 00 00 00 00".replace(" ","")
#print(f)
#fa=len(f)/2
#print(hex(len(f)),fa)
#gwrite2(start,f)
